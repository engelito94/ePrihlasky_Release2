...
<WebElementEntity>
   ...
   <tag></tag>
   <elementGuidId>fa56dda4-d0af-4394-ac87-27bf90a1093f</elementGuidId>
   <selectorCollection>
      <entry>
         <key>CSS</key>
   ...
   <webElementProperties>
    ...
    Osobné údaje žiaka
            ...
            Pridať žiaka podľa rodného čísla.
    ...
    Zadajte vo formáte XXXXXX/XXXX
        ...
        Filtre:
            ...
            Polia označené hviezdičkou sú povinné
                        ...
                        Kráľová 654/23, 01514, Smižany (Spišská Nová Ves), Slovenská republika
...
KráľovaKráľováKraľová ulicaKráľová ulicaKráľovanskáKráľovkaKráľovohoľskáKráľovohoľská cestaKráľovoľská cestaKráľovskáKráľovská cestaKráľovská ulica IIIKráľovské údolieVyhľadajte ulicu po zadaní prvých 3 znakov a vyberte ulicu zo zoznamu zobrazených ulíc!
    ...
    const controlSettingsDPD = {
        ...
        zmenenaPracovnaSchopnostRadio : {
            label: &quot;Zmenená pracovná schopnosť&quot;,
        ...
        specialneVVP: {
            label: &quot;Upravené podmienky prijímacieho konania (Špeciálne výchovno-vzdelávacie potreby)&quot;,
    ...
    const pageTextsVyberSkoly = {
        ...
        Vybrať školy a odbory
                ...
                Pridajte všetky školy a odbory, uvedené na prihláške.
    ...
    window['zastupca2AdresaControlSettings'] = {
        ...
        (nepovinné)
                ...
                Zákonní zástupcovia žiadajú, a dokladujú to vyhlásením oboch zákonných zástupcov, aby sa vo veciach súvisiacich s prijímacím konaním žiaka komunikovalo výhradne so zákonným zástupcom č. 1.
