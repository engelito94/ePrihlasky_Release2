...
WebUI.scrollToElement(findTestObject('Object Repository/Zak_test/Page_Vytvorenie elektronickej prihlky  ePrihlky/button_Prida do prihlky-Vseobecne'), 
    0)
...
WebUI.scrollToElement(findTestObject('Object Repository/Zak_test/Page_Vytvorenie elektronickej prihlky  ePrihlky/button_Prida do prihlky_1'), 
    0)
...
WebUI.scrollToElement(findTestObject('Object Repository/Zak_test/Page_Vytvorenie elektronickej prihlky  ePrihlky/button_Prida do prihlky_1_2'), 
    0)
...
WebUI.scrollToElement(findTestObject('Object Repository/Zak_test/Page_Vytvorenie elektronickej prihlky  ePrihlky/button_Prida do prihlky_1_2_3'), 
    0)
...
WebUI.scrollToElement(findTestObject(text), cislo)
