...
def udaje = subor.nacitajNahodnyZaznam(filePath + '/Data Files/detiSSRFO.txt')
...
WebUI.setText(findTestObject('Object Repository/Ditec_test/VytvoreniePrihlasky/Page_Vytvorenie elektronickej prihlky  ePrihlky/input_(nepovinn)_input-rodnePriezvisko'), 
    rodnePriezvisko)
...
WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/KontrolaZS/detailPrihlaskySS/Page_Podrobnosti prihlky  ePrihlky/div_Adresa trvalho pobytu_dietaAdresaTrvale_3d75f1'), 
    'Juríčková 896/2, 03657, Košariská, Slovenská republika', FailureHandling.OPTIONAL)
