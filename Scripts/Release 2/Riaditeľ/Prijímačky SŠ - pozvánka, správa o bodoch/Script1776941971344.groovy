...
assert teloMailu.contains(((((((('Vážený/á pán/pani Tomáš Lukáč týmto pozývame žiaka ' + meno) + ' ') + priezvisko) + ' ') + 
    datumNarodenia) + ' na prijímaciu skúšku 1. termín (1.kolo) do  odboru vzdelávania 2940M04-potravinárstvo - kvasná technológia, v škole Stredná škola pre AT, ktorá sa uskutoční dňa 25.09.2026 o 11:11 hod.  Miesto:  Stredná škola pre AT, 6.C  Váš prístupový kód: ') + 
