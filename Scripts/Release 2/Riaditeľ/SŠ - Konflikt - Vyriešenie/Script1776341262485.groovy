...
WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/Konflikty/Page_Podrobnosti prihlky  ePrihlky/div_Vzva bude zaslan nasledujcim osobm_vyzv_265567'), 
    'Tomáš Lukáč')

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/Konflikty/Page_Podrobnosti prihlky  ePrihlky/div_Dtum podania_vyzva-zz-item vyzva-zz-men_eddbd7'), 
    'Uršula Zálesná')
