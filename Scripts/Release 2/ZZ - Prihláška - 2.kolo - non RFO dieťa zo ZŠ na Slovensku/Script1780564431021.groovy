...
WebUI.click(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/checkbox_StrednaSkola2kolo'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/DietaZSMimoSR/Page_Vytvorenie elektronickej prihlky  ePrihlky/div_Kolo prijmacieho konania_koloPrijimacie_73f495'), 
    '2. kolo', FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/select_(nepovinn)_select-koloSelect'), 
    '2', true)

'Kontrola na ZŠ'
WebUI.setText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/input_Vyhadvanie v prihlkach_fulltext-input'), 
    (meno.toString() + ' ') + priezvisko.toString())

WebUI.click(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/button_Vyhadvanie v prihlkach_fulltext-inpu_1e6782'))

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/div_(nepovinn)_name-label'), 
    (priezvisko.toString() + ' ') + meno.toString())

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/div_Identifiktor prihlky_data-prihlaska-sta_1572f8'), 
    'Podaná')

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/div_Skontrolovan_badge red prihlaska-neskon_e372d0'), 
    'Neskontrolovaná')

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/div_Neskontrolovan_badge'), 
    'Elektronicky')
...
WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky naich iakov  ePrihlky/div_Neskontrolovan_grey-label datum-label'), 
    (((den.toString() + '.') + mesiac.toString()) + '.') + rok.toString())

prihlasovanie.odhlasPouzivatela()

prihlasovanie.prihlasRiaditela('930593020', 'hvisbbHiKeCSox23I94xOA==', GlobalVariable.F2A, '910021624')

WebUI.selectOptionByValue(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky a rozhodnutia  ePrihlky/select_(nepovinn)_select-koloIndexSelect'), 
    '2', true)

WebUI.setText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky a rozhodnutia  ePrihlky/input_Vyhadvanie v prihlkach_fulltext-input'), 
    (meno.toString() + ' ') + priezvisko.toString())

WebUI.click(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky a rozhodnutia  ePrihlky/button_Vyhadvanie v prihlkach_fulltext-inpu_1e6782'))

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky a rozhodnutia  ePrihlky/div_(nepovinn)_name-label'), 
    (priezvisko.toString() + ' ') + meno.toString())

WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky a rozhodnutia  ePrihlky/div_Neskontrolovan_badge'), 
    'Elektronicky')

'detail prihlášky SŠ'
WebUI.click(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/Kolo2/Page_Prihlky a rozhodnutia  ePrihlky/button_Detail_govuk-button govuk-button--se_40abef'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Zak_test/Release2/PrihlaskaZZ/KontrolaZS/detailPrihlaskySS/Page_Podrobnosti prihlky  ePrihlky/div_Stav kontroly_stavKontroly badge red - Copy'), 
    'Neskontrolovaná')
